---
title: "[백준] [Python] 🧩 N-Queen (Hard) 30243번"	#대괄호를 쓰려면 ""로 감싸주면 된다.
date: 2024-04-14 19:00:00 +09:00

categories: [Baekjoon, Diamond]
...
tags: [Algorithm, Baekjoon, C++, 비트마스킹, 백트래킹]

# Algorithm, Baekjoon, Python, Java, DB, Blog
# 백트래킹, 다이나믹프로그래밍, 비트마스킹
...
백트래킹과 전반적인 풀이 방식은 [🧩 N-Queen (Easy) 풀이](https://hoonably.github.io/posts/%EB%B0%B1%EC%A4%80-Python-N-Queen-Easy-30242%EB%B2%88/) 와 동일하다. 안봤다면 꼭 보고 오자.
